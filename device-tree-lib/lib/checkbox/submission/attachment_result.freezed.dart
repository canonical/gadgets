...
AttachmentResult _$AttachmentResultFromJson(Map<String, dynamic> json) {
  return _AttachmentResult.fromJson(json);
}
...
mixin _$AttachmentResult {
  ...
  @JsonKey(ignore: true)
  $AttachmentResultCopyWith<AttachmentResult> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AttachmentResultCopyWith<$Res> {
  factory $AttachmentResultCopyWith(
...
/// @nodoc
class _$AttachmentResultCopyWithImpl<$Res>
    implements $AttachmentResultCopyWith<$Res> {
  _$AttachmentResultCopyWithImpl(this._value, this._then);

  final AttachmentResult _value;
  // ignore: unused_field
  final $Res Function(AttachmentResult) _then;
...
/// @nodoc
abstract class _$$_AttachmentResultCopyWith<$Res>
    implements $AttachmentResultCopyWith<$Res> {
  factory _$$_AttachmentResultCopyWith(
          _$_AttachmentResult value, $Res Function(_$_AttachmentResult) then) =
...
/// @nodoc
class __$$_AttachmentResultCopyWithImpl<$Res>
    extends _$AttachmentResultCopyWithImpl<$Res>
    implements _$$_AttachmentResultCopyWith<$Res> {
  __$$_AttachmentResultCopyWithImpl(
      _$_AttachmentResult _value, $Res Function(_$_AttachmentResult) _then)
      : super(_value, (v) => _then(v as _$_AttachmentResult));

  @override
  _$_AttachmentResult get _value => super._value as _$_AttachmentResult;
  ...
  $Res call({
    ...
    return _then(_$_AttachmentResult(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_AttachmentResult implements _AttachmentResult {
  ...
  @override
  String toString() {
    return 'AttachmentResult(id: $id, fullId: $fullId, name: $name, certificationStatus: $certificationStatus, category: $category, categoryId: $categoryId, status: $status, outcome: $outcome, comments: $comments, ioLog: $ioLog, duration: $duration)';
  }
  ...
  _$$_AttachmentResultCopyWith<_$_AttachmentResult> get copyWith =>
      __$$_AttachmentResultCopyWithImpl<_$_AttachmentResult>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_AttachmentResultToJson(
      this,
    );
  }
}
