...
class _$_Device implements _Device {
  ...
  @override
  String toString() {
    return 'Device(bus: $bus, driver: $driver, name: $name, path: $path, product: $product, productSlug: $productSlug, category: $category, vendor: $vendor, vendorSlug: $vendorSlug, productId: $productId, vendorId: $vendorId, interface: $interface, mac: $mac)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.productSlug, productSlug) &&
            const DeepCollectionEquality().equals(other.category, category) &&
            const DeepCollectionEquality().equals(other.vendor, vendor) &&
            const DeepCollectionEquality()
                .equals(other.vendorSlug, vendorSlug) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(productSlug),
      const DeepCollectionEquality().hash(category),
      const DeepCollectionEquality().hash(vendor),
      const DeepCollectionEquality().hash(vendorSlug),
